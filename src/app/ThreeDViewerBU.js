...
import { loadGLBModel, toHexString, changeColorOfAllComponents } from "./utils";
...
const ThreeDViewer = () => {
  ...
  const handleChangeColor = (colorTshirt) => {
    changeColorOfAllComponents(sceneRef.current, colorTshirt);
    updateTexture();
  ...
  useEffect(() => {
    ...
    preloadImageAndAddToCanvas("/shirt4.001.png");
